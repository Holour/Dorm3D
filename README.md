...
- 界面采用北邮蓝 `#003399` 与白色，统一按钮、床位定位、尺寸卡片和坐姿控件；色彩参考[学校官方配色说明](https://gce.bupt.edu.cn/xygk/yhjj.htm)。家具仍按照片呈现木纹与金属材质。
...
- 支持 WASD / 方向键移动观察位置；新增固定位置的椅上视角，坐姿下用按键或拖动转头，可点击键盘架、抽屉和衣柜互动。

![蓝白主题交互界面](exports/interface.png)
...
- 坐姿中点击本床键盘架或抽屉可拉出、收回，点击衣柜可开关柜门；手机可直接轻触对应部件。“离开座位”、Esc 或其他观察视角可退出坐姿。
...
已通过 32 组几何、搜索、移动与坐姿交互检查。导出文件通过 Khronos glTF Validator 检查：0 错误、0 警告，包含 6 个床位、6 把椅子、4 架梯子和全部 45 个实测记录 ID。
